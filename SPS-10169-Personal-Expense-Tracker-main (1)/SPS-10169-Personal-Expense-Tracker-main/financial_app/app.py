...
app.config['MYSQL_USER'] = 'F8mNJm6qzi'
app.config['MYSQL_PASSWORD'] = 'NOVeVUED7A'
app.config['MYSQL_DB'] = 'F8mNJm6qzi'

app.config["MAIL_SERVER"] = 'smtp.gmail.com'
app.config['MAIL_PORT']=465
app.config['MAIL_USERNAME']="deepaashok5656@gmail.com"
app.config['MAIL_PASSWORD']=  "gmail12345@"
